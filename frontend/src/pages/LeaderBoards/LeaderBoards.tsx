    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center gap-4">
                <IconTrophy size={48} className="text-emerald-500 animate-bounce" />
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-12 animate-fade-in">
                    <div className="inline-flex items-center justify-center p-3 bg-stone-900/80 rounded-2xl border border-emerald-300/20 shadow-[0_0_30px_-10px_rgba(52,211,153,0.3)] mb-4">
                        <IconTrophy size={48} className="text-emerald-300" />
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-black text-stone-100 tracking-tight">
                        Global <span className="text-transparent bg-clip-text bg-linear-to-r from-lime-300 to-emerald-300">Rankings</span>
                    </h1>
                </div>

                {/* Table */}
                <div className="bg-stone-900/60 rounded-3xl border border-stone-800 shadow-2xl backdrop-blur-md overflow-hidden">
                        ...
                        <table className="w-full text-left border-collapse min-w-[600px]">
                            ...
                            <tbody className="divide-y divide-stone-800/50">
                                ...
                                {players.length === 0 ? (
                                    ...
                                    players.map((player) => (
                                        <tr key={player.id} className="hover:bg-stone-800/40 transition-colors duration-200 group">
