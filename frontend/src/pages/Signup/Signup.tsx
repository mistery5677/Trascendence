...
export function Signup() {
	...
	return (
		<>
			{/* Adding background image and make this div take up the full screen */}
			<div
			...
			>
				<div className="max-w-4xl flex items-center mx-auto md:min-h-screen p-4">
					<div className="bg-white  grid md:grid-cols-3 items-center [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] rounded-xl overflow-hidden">
