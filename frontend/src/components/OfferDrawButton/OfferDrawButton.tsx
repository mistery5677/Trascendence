...
const contentClass =
	"border border-green-600 fixed left-1/2 top-1/2 z-50 w-[min(calc(100vw-2rem),24rem)] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-green-700 bg-stone-900 p-4 text-stone-100 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95";
							...
							<div className="mt-4 flex justify-end gap-2">
								...
								<AlertDialog.Action asChild>
									<button
										type="button"
										onClick={() => func()}
										className="rounded-md bg-green-700 px-3 py-1.5 text-sm text-stone-100 hover:bg-green-600 transition">
										Offer Draw 🤝
									</button>
								</AlertDialog.Action>
							</div>
