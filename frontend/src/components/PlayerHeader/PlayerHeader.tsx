...
export function PlayerHeader({
	...
	return (
		<div
			...
			{/* left user */}
			<div
				className={`flex items-center gap-1.5 rounded-xl p-1.5 transition-all duration-500 sm:gap-6 sm:p-2 sm:pr-10 ${
			...
			{/* right user */}
			<div
				className={`flex items-center gap-1.5 rounded-xl p-1.5 transition-all duration-500 sm:gap-2 sm:p-2 justify-end sm:pl-10 ${
					color != null && currentTurn !== color
						? "bg-emerald-500/14 ring-1 ring-emerald-300/35 scale-[1.03]"
						: "opacity-65 scale-100"
				}`}>
