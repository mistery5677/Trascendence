...
export function Timer({ timeLeftInSeconds, isRunning, onTimeUp }: TimerProps) {
	...
	return (
		<div
			className={`font-mono font-black text-sm sm:text-base xl:text-xl 2xl:text-2xl tracking-wider ${timeLeftInSeconds <= 10 ? "text-red-500 animate-pulse" : "text-stone-100"}`}>
			{formattedTime}
		</div>
	);
}
