export function DrawModal({ onResponse }: { onResponse: (accept: boolean) => void }) {
	return (
		<div className="absolute inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm">
			<div className="bg-slate-900 border border-emerald-500/50 p-8 rounded-2xl flex flex-col items-center gap-4 shadow-2xl">
				<h3 className="text-2xl font-bold text-white text-center">🤝 Draw Offered</h3>
				<p className="text-slate-300">Your opponent proposes a draw. Do you accept?</p>
