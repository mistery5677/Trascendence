		...
		<>
			<div className="relative min-h-screen overflow-hidden bg-stone-800">
				...
				<div className="relative z-10 flex min-h-screen items-center justify-center px-6">
					<div className="w-full max-w-sm rounded-3xl border border-emerald-300/20 bg-stone-900/70 p-8 text-center shadow-[0_24px_50px_-24px_rgba(0,0,0,0.85)] backdrop-blur-md">
